...
<%--                                <li class="active">Sửa thông tin chất liệu</li>--%>
<%--                            </ol>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Sửa thông tin giảm giá</h3></strong>
                    </div>
                ...
                <div class="card-body">
                    <sf:form action="/giam-gia/sua/${giamGia.id}" method="post" modelAttribute="giamGia" class="row">
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            ...
                            <sf:input path="giaTriGiam" style="margin-top: 5px;"  type="number" class="form-control"/>
                            <sf:errors path="giaTriGiam" cssClass="text-danger" />

                        </div>
                        <div class="col-lg-6" style="margin-top: 20px;">
                            Ngày bắt đầu (<i class="fa fa-asterisk" style="color: red;"></i>)
                            <sf:input path="ngayBatDau" name="ngayBatDau" type="date" class="form-control"/>
                            <sf:errors path="ngayBatDau" cssClass="text-danger" />
                        </div>
                        <div class="col-lg-6" style="margin-top: 20px;">
                            Ngày kết thúc (<i class="fa fa-asterisk" style="color: red;"></i>)
                            <sf:input path="ngayKetThuc" name="ngayKetThuc" type="date" class="form-control"/>
                        ...
                        <div class="col-lg-3" style="margin-top: 20px; ">
                            ...
                            <a href="/giam-gia/hien-thi" class="btn btn-secondary" > <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
