...
<%--                                <li class="active">Sửa thông tin loại sản phẩm</li>--%>
<%--                            </ol>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Sửa thông tin loại sản phẩm</h3></strong>
                    </div>

                </div>
                <div class="card-body">
                    <sf:form action="/loai-sp/sua/${loaiSanPham.id}" method="post" modelAttribute="loaiSanPham" class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-3" style="margin-top: 20px; ">
                            ...
                            <a href="/loai-sp/hien-thi" class="btn btn-secondary" > <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
