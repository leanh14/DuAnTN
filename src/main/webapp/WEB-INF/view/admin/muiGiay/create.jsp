        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Thêm mới Mũi giày</h3></strong>
                    </div>

                </div>
                <div class="card-body">
                    <sf:form action="/mui-giay/them" method="post" modelAttribute="muiGiay" class="row">
                        <div class="col-lg-6">
                            ...
                            <c:if test="${trungMa==true}">
                                <p class="text-danger">Mã mũi giày đã có trong hệ thống, vui lòng nhập mã mới</p>
                            </c:if>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <c:if test="${trungTen==true}">
                                <p class="text-danger">Loại mũi giày đã có trong hệ thống, vui lòng nhập tên mới</p>
                            </c:if>
                        </div>
                        ...
                        <div class="col-lg-4" style="margin-top: 20px; ">
                            ...
                            <a href="/mui-giay/hien-thi" class="btn btn-secondary"  style="margin-left: 10px;"> <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-10">
                            <strong class="card-title" ><h3>Danh sách Mũi giày</h3></strong>
                        </div>
                    </div>
                    <br>
                    <form action="/mui-giay/hien-thi" method="get">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover no-wrap">
                            ...
                            <tbody>
                            <c:forEach items="${dsMuiGiay}" var="muiGiay" varStatus="muigiay">
                                <tr>
                                    <th scope="row">${muigiay.index +1}</th>
                                    <td > ${muiGiay.ma}</td>
                                    <td > ${muiGiay.ten}</td>
                                    <td > ${muiGiay.moTa}</td>
                                    <td > ${muiGiay.nguoiTao}</td>
                                    <td > ${muiGiay.nguoiSua}</td>
                                    <td > ${muiGiay.ngayTao}</td>
                                    <td > ${muiGiay.ngaySua}</td>
                                    <td > ${muiGiay.trangThai == 1 ? 'Hoạt động': 'Ngưng hoạt động'}</td>
                                    <td > <a href="/mui-giay/view-sua/${muiGiay.id}" class="btn btn-success"> Xem <i class="menu-icon fa fa-pencil-square-o"></i> </a> </td>
                                    <td > <a href="/mui-giay/xoa/${muiGiay.id}" class="btn btn-warning"
                                             onclick="return confirm('Bạn chắc chắn muốn xóa mũi giày ${muiGiay.ten} ?')"> <i class="menu-icon fa fa-trash-o"></i> Xóa</a> </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
                                ...
                                <c:if test="${totalPage>0}">
                                    <ul class="pagination justify-content-end">
                                        <c:if test="${pageChoosedNumber > 0}">
                                            <li class="page-item">
                                                <a class="page-link" href="/mui-giay/hien-thi?${pageChoosedNumber-1}" tabindex="-1" aria-disabled="true">Previous</a>
                                            </li>
                                        </c:if>
                                            ...
                                            <c:choose>
                                                <c:when test="${pageChoosedNumber==loop.index}">
                                                    <li class="page-item active" aria-current="page" >
                                                        <a name="page" class="page-link"   href="/mui-giay/hien-thi?page=${loop.index}">${loop.index + 1}</a>
                                                    </li>
                                                </c:when>
                                                <c:otherwise>
                                        ...
                                        <c:if test= "${pageChoosedNumber < (totalPage-1)}">
                                            <li class="page-item">
                                                <a class="page-link" href="/mui-giay/hien-thi?page=${pageChoosedNumber+1}">Next</a>
                                            </li>
                                        </c:if>
