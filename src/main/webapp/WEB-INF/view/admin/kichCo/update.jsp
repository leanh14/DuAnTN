            ...
            <div class="animated fadeIn">
                    <div class="card col-lg-12">
                        <div class="card-header">
                            <div>
                                    <strong class="card-title" ><h3>Sửa thông tin kích cỡ</h3></strong>
                            </div>

                        </div>
                        <div class="card-body">
                            <sf:form action="/kich-thuoc/sua/${kichThuoc.id}" method="post" modelAttribute="kichThuoc" class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-3" style="margin-top: 20px; ">
                                    ...
                                    <a href="/kich-thuoc/hien-thi" class="btn btn-secondary" > <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                                </div>
                            </sf:form>
