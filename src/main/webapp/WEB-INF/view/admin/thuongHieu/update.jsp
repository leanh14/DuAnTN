...
<%--                                <li class="active">Sửa thông tin thương hiệu</li>--%>
<%--                            </ol>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Sửa thông tin thương hiệu</h3></strong>
                    </div>

                </div>
                <div class="card-body">
                    <sf:form action="/thuong-hieu/sua/${thuongHieu.id}" method="post" modelAttribute="thuongHieu" class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <c:if test="${trungTen==true}">
                                <p class="text-danger">Tên thương hiệu đã có trong hệ thống, vui lòng nhập tên mới</p>
                            </c:if>
                        </div>
                        ...
                        <div class="col-lg-3" style="margin-top: 20px; ">
                            ...
                            <a href="/thuong-hieu/hien-thi" class="btn btn-secondary" > <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
