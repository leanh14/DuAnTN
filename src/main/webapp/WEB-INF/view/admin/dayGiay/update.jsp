...
<%--                                <li class="active">Sửa thông tin dây giày</li>--%>
<%--                            </ol>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Sửa thông tin dây giày</h3></strong>
                    </div>

                </div>
                <div class="card-body">
                    <sf:form action="/day-giay/sua/${dayGiay.id}" method="post" modelAttribute="dayGiay" class="row">
                        <div class="col-lg-6">
                            ...
                            <c:if test="${trungMa==true}">
                                <p class="text-danger">Mã dây dày đã có trong hệ thống, vui lòng nhập mã mới</p>
                            </c:if>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <c:if test="${trungTen==true}">
                                <p class="text-danger">Loại dây dày đã có trong hệ thống, vui lòng nhập tên mới</p>
                            </c:if>
                        </div>
                        ...
                        <div class="col-lg-3" style="margin-top: 20px; ">
                            ...
                            <a href="/day-giay/hien-thi" class="btn btn-secondary" > <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
