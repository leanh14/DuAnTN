                ...
                <div class="card-body">
                    <sf:form action="/phieu-giam-gia/sua/${phieuGiam.id}" method="post" modelAttribute="phieuGiam" class="row">
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            ...
                            <sf:input path="ngayBatDauApDung" name="ngayBatDauApDung" type="date" class="form-control"
                                      required="required"/>
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            ...
                            <sf:input path="ngayKetThucApDung" name="ngayKetThucApDung" type="date" class="form-control"
                                      required="required"/>
