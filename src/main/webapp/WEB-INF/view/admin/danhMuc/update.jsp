        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Sửa thông tin danh mục</h3></strong>
                    </div>

                </div>
                <div class="card-body">
                    <sf:form action="/danh-muc/sua/${danhMuc.id}" method="post" modelAttribute="danhMuc" class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <c:if test="${trungTen==true}">
                                <p class="text-danger">Loại danh mục đã có trong hệ thống, vui lòng nhập tên mới</p>
                            </c:if>
                        </div>
                        ...
                        <div class="col-lg-3" style="margin-top: 20px; ">
                            ...
                            <a href="/danh-muc/hien-thi" class="btn btn-secondary" > <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
