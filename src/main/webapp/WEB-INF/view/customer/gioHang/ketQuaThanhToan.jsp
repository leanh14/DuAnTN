...
<head>
    ...
    <title>Kết quả thanh toána</title>
...
<div class="page-wrapper">
    ...
    <main class="main">
        <div class="page-header text-center" style="background-image: url('/user/assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">Kết quả thanh toán<span>đơn hàng</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
        ...
        <div class="page-content">
            <div class="container">
                <div class="row d-flex justify-content-center" style="margin-top: 20px;">
                    <aside class="col-lg-4 ml-4 " style="background-color: white !important;">
                        <div class="row " >
                            <div class="col-lg-12 shadow p-3 mb-5 bg-white rounded ml-4">
                                <h3 class="summary-title mt-2">Thanh toán thành công</h3><!-- End .summary-title -->
                                <p>Khách hàng: ${hoaDonVuaThanhToan.tenKH}</p>
                                <p >Tra cứu đơn hàng: <a href="/gio-hang/view-traThongTinDonHang?searchByMaHoaDon=${hoaDonVuaThanhToan.ma}" ><u style="color: #1a8cff !important; font-size: 16px;">Nhấn tại đây !</u></a> </p>
                                <div class="row d-flex justify-content-end" style="margin-top: 10px; margin-right: 10px;">
                                    <a href="/gio-hang/view-trangChu2" class="btn btn-primary">Quay trở về trang chủ</a>
                                </div>
                            </div>
                        </div><!-- End .summary -->
                    </aside><!-- End .col-lg-3 -->
